...
const RejectModal = ({isRejectModalPartOpen, setIsRejectModalPartOpen}) => {
  return (
    <Modal 
          isOpen={isRejectModalPartOpen} 
          onOpenChange={setIsRejectModalPartOpen}
          backdrop="opaque"
          classNames={{
            body: "py-6 ",
          ...
          <ModalContent>
            {(onClose) => (
              <>
                ...
                <ModalBody>
                  <p>
                    Are you sure want to <span className='text-red-400'>Reject</span> this user as a partner?
                  </p>
                </ModalBody>
                <ModalFooter>
