...
const AcceptModal = ({isAcceptModalPartOpen, setIsAcceptModalPartOpen}) => {
  return (
    <Modal 
      isOpen={isAcceptModalPartOpen} 
      onOpenChange={setIsAcceptModalPartOpen}
      backdrop="opaque"
      classNames={{
        body: "py-6 ",
      ...
      <ModalContent>
        {(onClose) => (
          <>
            ...
            <ModalBody>
              <p>
                Are you sure want to <span className='text-blue-400'>accept</span> this user as a partner?
              </p>
            </ModalBody>
            <ModalFooter>
